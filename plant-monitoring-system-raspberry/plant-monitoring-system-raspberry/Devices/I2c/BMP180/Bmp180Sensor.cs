...
namespace plant_monitoring_system_raspberry.Devices.I2c.Bmp180
{
    public class Bmp180Sensor : IDisposable
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            _i2CBarometer = controller.GetDevice(settings);

            // Ensure that the 
            if (_i2CBarometer == null)
            {
                throw new I2CAddressException(settings.SlaveAddress.ToString());
            }
